...
/**
 * This class is used to convert a given number to it's equivalent in another valid
 * numerical system. Each program is provided with 3 user inputs, a source radix, the number
 * and a target radix
 * */
